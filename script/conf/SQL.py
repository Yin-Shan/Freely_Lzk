...
select count(*) from t_channel where i_data_source=2 and i_channel_type=51 and s_subnetwork='湖州华为SDH网管'
 union all 
select count(*) from t_channel where i_data_source=2 and i_channel_type=51 and s_subnetwork='二干华为SDH网管'
 union all 
select count(*) from t_channel where i_data_source=2 and i_channel_type=51 and s_subnetwork='省网管华为OTN网管'
 union all 
...
select count(*) from T_CHANNEL c where S_SUBNETWORK='湖州华为SDH网管'and I_DATA_SOURCE=2
 union all 
select count(*) from T_CHANNEL c where S_SUBNETWORK='二干华为SDH网管'and I_DATA_SOURCE=2
 union all 
select count(*) from T_CHANNEL c where S_SUBNETWORK='省网管华为OTN网管'and I_DATA_SOURCE=2
 union all 
...
union all
select isnull(a.s_subnetwork,b.fine_s_subnetwork) unit ,isnull(a.nubmer,0) nubmer ,isnull(b.fine_nubmer,0) fine_nubmer
 from (select count(*) as nubmer ,s_subnetwork from t_channel  where I_STATE  in(1,6,7)  and s_subnetwork='二干华为SDH网管' group by s_subnetwork) A FULL JOIN 
(select count(*) as fine_nubmer,s_subnetwork fine_s_subnetwork  from t_channel  where I_STATE not  in(1,6,7)  and s_subnetwork='二干华为SDH网管'  group by s_subnetwork) b on a.s_subnetwork=b.fine_s_subnetwork
union all
select isnull(a.s_subnetwork,b.fine_s_subnetwork) unit ,isnull(a.nubmer,0) nubmer ,isnull(b.fine_nubmer,0) fine_nubmer
 from (select count(*) as nubmer ,s_subnetwork from t_channel  where I_STATE  in(1,6,7)  and s_subnetwork='省网管华为OTN网管' group by s_subnetwork) A FULL JOIN 
(select count(*) as fine_nubmer,s_subnetwork fine_s_subnetwork  from t_channel  where I_STATE not  in(1,6,7)  and s_subnetwork='省网管华为OTN网管'  group by s_subnetwork) b on a.s_subnetwork=b.fine_s_subnetwork
union all
select isnull(a.s_subnetwork,b.fine_s_subnetwork) unit ,isnull(a.nubmer,0) nubmer ,isnull(b.fine_nubmer,0) fine_nubmer
...
test_sql1 = "select * from jhExc_Summary where iCountTime>'2019-12-20'"
test_sql2 = "select * from jhExc_Anomaly where iCountTime>'2019-12-20'"
