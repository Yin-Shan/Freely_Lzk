...
from script.conf.SQL import test_sql1,test_sql2
template = os.path.join(project_path,"template","模板.xlsx")
sqlpath = os.path.join(project_path,"script","conf","SQL.py")
